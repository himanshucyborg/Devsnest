...
app.get("/status", (req, res) => {
    res.status(200);   //just returns the status count only
    res.send("hemlo");
})

//the above function can be written like this. 

app.get("/statusi", (req, res) => {           //statusi can be written as abcd or anything right, ref below
    res.sendStatus(500).json({ a: 1 });
})
//This is pipelining - 1 function after another is called
